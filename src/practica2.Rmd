...
**a). Estudiar visualmente y analiticamente las posibles correlaciones entre:**
...
Dado que obtenemos un p-valor mayor que el nivel de significación $pValor \gt \alpha$, entonces no rechazamos la hipótesis nula. Por tanto, podemos concluir que el precio de un coche de color blanco no tiene por qué ser mayor al precio de un coche de color negro. 
...
De las gráficas anteriores se puede extraer la presencia de outliers que están perturbando el módelo y valores alejados del comportamiento de la mayoría de los puntos (sobre todo en valores pequeños y altos de x).


### 2.6. Conclusiones

Finalmente, a partir de todo el estudio realizado, anotamos las siguientes conclusiones dando respuesta
a las preguntas inialmente planteadas.
